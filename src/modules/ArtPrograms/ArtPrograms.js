...
function ArtPrograms() {
    ...
    useEffect(() => {
        (async () => {
            try {
                  const response = await fetch('http://frankos-museum-backend.azurewebsites.net/api/program-art');
    ...
    return (
        <div style={{margin: '3% 7% 7% 7%'}}>
            <div className="igraSans" style={{fontSize: '71px', lineHeight: '71px'}}>Мистецькі програми</div>
